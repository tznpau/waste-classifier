...
def train_step(
    ...
    Turns a target model to training mode, and runs through all the training steps:
    - forward pass
    - loss calculation
    - optimizer step
    """
...
def train(
    ...
    """
    Trains and tests a model with learning rate decay.
